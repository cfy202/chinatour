        ...
        <div class="block-flat">
          ...
          <div class="content">
             <form class="form-horizontal group-border-dashed" id="formId" action="addOrders.jhtml" method="post" parsley-validate novalidate onsubmit="return disabledSubmit();">     
			  ...
			  <div class="form-group">				
				 ...
				 <div class="col-sm-6">			 
					<label id="defaultType" class="radio-inline">
						...
						<input type="hidden" name="tourType" id="tourType" class="form-control" value="1">
              ...
              <div class="form-group" id="checkboxId" style="display:none;">
					...
					<div class="col-sm-6">
						<div class="switch" id ="mySwitch" data-on-label="Yes" data-off-label="No">
							<input type="checkbox" checked name="str">
						</div>
					</div>
				</div>
...
<script type="text/javascript">
    ...
    function checkTourCode(tourCodeInput){
	    ...
	    $.post("checkTourCode.jhtml", {"tourCode":tourCode}, function(tour){
	    	...
	    	if(tour == ''){
	    		...
	    		$form.attr("action","addOrders.jhtml");
	    	}
		});
    }
	...
	function selectTour(){
    	...
    	$("#tourCodeT").select2({
			...
			ajax:{
				url:'[@spring.url '/admin/tour/listSelect.jhtml'/]',	//地址
	...
	$("#tourCode_option").click(function(){
		if($("#tourCode_option").html()=="New"){
			...
			$("#newCode").show();
			$("#checkboxId").show();
			$(".select2-choice select2-default").hide();
