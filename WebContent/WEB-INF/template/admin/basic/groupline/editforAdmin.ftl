          ...
          <div class="content">
            <form class="form-horizontal group-border-dashed" action="updateforAdmin.jhtml" method="post">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-6">
                  <select type="text" name="operater" class="select2">
	                    ...
	                    <option value="北京操作中心" [#if "${groupLine.operater='北京操作中心'}"] selected="selected" [/#if]>北京操作中心</option>
	                    <option value="苏州操作中心" [#if "${groupLine.operater='苏州操作中心'}"] selected="selected" [/#if]>苏州操作中心</option>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-6">
                  	<input type="text" name="vender" class="form-control" value="${groupLine.vender}" />
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <label class="col-sm-3 control-label">Provider Code</label>
                <div class="col-sm-6">
                  	<input type="text" name="tourNo" class="form-control" value="${groupLine.tourNo}"/>
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-6">
                	<label class="radio-inline">
						<div class="iradio_square-blue" style="position: relative;" aria-checked="false" aria-disabled="false">
							<input class="icheck" type="radio" name="isSystem" value="3"  [#if "${groupLine.isSystem==3}"] checked="checked" [/#if] style="position: absolute; opacity: 0;">
								<ins class="iCheck-helper"
									style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: none repeat scroll 0% 0% rgb(255, 255, 255); border: 0px none; opacity: 0;">
								</ins>
						</div>
